...
class Game extends Phaser.Scene {
	...
	playOnce() {
		...
		MainGame.Sfx.play("music", "main");
		if (MainGame.isAPI && this.isGoTutorial && MainGame.firstClickApi) MainGame.API_POKI.gameplayStart();
		MainGame.firstClickApi = false
	}
	initSettingsGame() {
...
class GameGui extends Phaser.Scene {
	...
	showFinishWindow(vIsWin) {
		...
		if (vIsWin) {
			...
			if (MainGame.isAPI) {
				if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.buttonWinX2.setEnable(true)
			} else {
	...
	showOfferTV() {
		...
		if (MainGame.isAPI) {
			if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.buttonPanelTV.setEnable(true)
		} else {
	...
	showOfflineEarningWindow(vValueCoins) {
		...
		if (MainGame.isAPI) {
			if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.offlineEarningBtnAds.setEnable(true)
		} else {
	...
	showUpgradeWindow(vLevelGun) {
		...
		if (MainGame.isAPI) {
			if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.buttonFreeUpgrade.setEnable(true)
		} else {
	...
	showBoosterWindow(vBonus) {
		...
		if (MainGame.isAPI) {
			if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.boostBtnAds.setEnable(true)
		} else {
	...
	checkFortunaWheelWindow() {
		...
		if (MainGame.isAPI) {
			if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) this.buttonFortunaWheel.setEnable(true)
		} else {
				...
				if (i > 0 && this.gameScreen.nextCarLevel < i + 6) {
					if (i == this.gameScreen.nextCarLevel - 5) {
						if (this.gameScreen.ALLOW_ADS_CAR) {
							...
							if (MainGame.isAPI) {
								if (MainGame.API_POKI && MainGame.API_POKI.api_isAdblock) item.btn.setEnable(true)
							} else {
